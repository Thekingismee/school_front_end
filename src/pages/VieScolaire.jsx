...
function VieScolaire() {
 ...
 <header className="header1">
            <h1 className='inscription-titre'>Vie Scolaire</h1>
        </header>
...
<p>
  Au sein du <strong>Groupe Scolaire l'Atome à Lissasfa</strong>, la vie scolaire est pensée pour accompagner chaque élève dans son développement global. Entre activités périscolaires, services pratiques et suivi personnalisé, nous créons un environnement bienveillant où chaque enfant peut s’épanouir, grandir et réussir, en toute sécurité.</p>
         ...
         <div className="about-image-wrapper">
          <img src="/Muslim graduation-bro.png" alt="Groupe Scolaire L'Atome" />
        </div>
      </div>
    </section>
...
<style jsx>{`
  ...
  color: #fff;
//   background: #780000;
  background-image: url("/1maternelle.jpg");
...
.about-section {
      background-image: linear-gradient(to right, #81b9eeff, #4c97deff, #4c97deff);
