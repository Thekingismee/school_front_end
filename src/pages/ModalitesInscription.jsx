        ...
        <div>
            ...
            <header className="hero-section">
                ...
                <div className="hero-content">
                    <h1 className="hero-title">
                        ...
                        <span className="hero-title-accent"> Pourquoi L'Atome</span>
                    </h1>
            ...
            <section className="about-section">
                <div className="about-container">
                    ...
                    <div className="about-content">
                        <h1>
                            Un accueil personnalisé, une démarche fluide, un accompagnement humain
                        </h1>
            ...
            <p>
              Au sein du <strong>Groupe Scolaire l'Atome à Lissasfa</strong>, la vie scolaire est pensée pour accompagner chaque élève dans son développement global. Entre activités périscolaires, services pratiques et suivi personnalisé, nous créons un environnement bienveillant où chaque enfant peut s'épanouir, grandir et réussir, en toute sécurité.
                        ...
                        <p>
                            <span>
                                Inscrire son enfant au Groupe Scolaire L'Atome, c’est intégrer une communauté éducative exigeante, bienveillante et engagée. C’est pourquoi nous avons conçu un processus d’admission clair, progressif et personnalisé, à l’image de notre projet pédagogique.

                            </span>
                            <span>
                                Que vous soyez parents d’un tout-petit entrant à l’école pour la première fois, ou d’un élève en transition de cycle, notre équipe vous accompagne à chaque étape — avec attention, transparence et écoute.
                            </span>
                        </p>
