...
// import { Send, CheckCircle, User, Phone, Mail, MapPin, Briefcase, Building2, Calendar, FileText, Upload } from 'lucide-react';
...
//       const contratField = name.split('.')[1];
//       setFormData(prev => ({
//         ...prev,
//         contrat: {
//           ...prev.contrat,
//           [contratField]: checked
//         }
//       }));
//     } else {
//       setFormData(prev => ({
...
//     // Validation: max 5Mo pour le CV
//     if (name === 'cv' && file && file.size > 5 * 1024 * 1024) {
...
//       if (name === 'cv' && !validTypes.includes(file.type)) {
...
//     // Au moins un type de contrat sélectionné
...
//         <img
//           src="/inscrip2.jpg"
//           alt="Recrutement Groupe Scolaire L'Atome"
...
//             </div>
//           ) : (
//             <form className="inscription-form" onSubmit={handleSubmit} encType="multipart/form-data">
...
//                   <label htmlFor="ville">
//                     Ville de résidence <span className="required">*</span>
//                   </label>
//                   <div className="input-wrapper">
...
//                     >
//                       <option value="le-monceau-lissasfa">Le Monceau – Lissasfa</option>
//                     </select>
//                   </div>
//                 </div>
//               </div>
...
//                     <input
//                       type="checkbox"
//                       name="contrat.tempsPlein"
//                       checked={formData.contrat.tempsPlein}
//                       onChange={handleChange}
//                     />
//                     <span className="checkbox-custom"></span>
//                     Temps plein
...
//                     <input
//                       type="checkbox"
//                       name="contrat.tempsPartiel"
//                       checked={formData.contrat.tempsPartiel}
//                       onChange={handleChange}
//                     />
//                     <span className="checkbox-custom"></span>
//                     Temps partiel
...
//                   <label htmlFor="cv">
//                     CV (PDF, DOC – max 5 Mo) <span className="required">*</span>
//                   </label>
...
//                       <Upload size={16} />
//                       {formData.cv ? formatFileName(formData.cv) : 'Parcourir...'}
//                     </label>
...
//                       className="file-input"
//                     />
//                     <label htmlFor="lettre" className="file-label">
//                       <Upload size={16} />
//                       {formData.lettre ? formatFileName(formData.lettre) : 'Parcourir...'}
//                     </label>
...
//                       className="file-input"
//                     />
//                     <label htmlFor="diplomes" className="file-label">
//                       <Upload size={16} />
//                       {formData.diplomes ? `${formData.diplomes.length} fichier(s)` : 'Parcourir...'}
//                     </label>
...
//                       name="disponibilite"
//                       value="immediate"
//                       checked={formData.disponibilite === 'immediate'}
//                       onChange={handleChange}
//                     />
...
//                       name="disponibilite"
//                       value="1mois"
//                       checked={formData.disponibilite === '1mois'}
//                       onChange={handleChange}
//                     />
//                     <span className="radio-custom"></span>
//                     Dans 1 mois
...
//                       name="disponibilite"
//                       value="rentree"
//                       checked={formData.disponibilite === 'rentree'}
//                       onChange={handleChange}
//                     />
//                     <span className="radio-custom"></span>
...
//                       name="disponibilite"
//                       value="autre"
//                       checked={formData.disponibilite === 'autre'}
//                       onChange={handleChange}
//                     />
//                     <span className="radio-custom"></span>
//                     Autre
...
//                     <input
//                       type="text"
//                       id="disponibiliteAutre"
//                       name="disponibiliteAutre"
//                       value={formData.disponibiliteAutre}
//                       onChange={handleChange}
...
//                     onChange={handleChange}
//                     rows="5"
//                     placeholder="Motivations, expériences pertinentes, questions..."
//                   />
//                 </div>
//               </div>
...
//                 dans le cadre de notre processus de recrutement. Conformément à la loi,
...
//         .form-field select.fixed-select {
...
//code avec nom monceau et pas l'atome
...
const JoinUs = () => {
    ...
    const handleFileChange = e => {
        ...
        if (name === "cv" && file && file.size > 5 * 1024 * 1024) {
            setErrors(prev => ({
                ...prev,
                cv: "Le CV ne doit pas dépasser 5 Mo"
            }));
            return;
        }
    ...
    const validateForm = () => {
        ...
        if (!hasContrat)
            newErrors.contrat =
                "Veuillez sélectionner au moins un type de contrat";

        // Disponibilité requise
        if (!formData.disponibilite)
            newErrors.disponibilite =
                "Veuillez sélectionner votre disponibilité";
        if (
            formData.disponibilite === "autre" &&
            !formData.disponibiliteAutre.trim()
        ) {
            newErrors.disponibiliteAutre =
                "Veuillez préciser votre disponibilité";
        }
    ...
    const handleSubmit = async e => {
        ...
        setTimeout(() => {
            ...
            setFormData({
                ...
                telephone: "",
                ville: "",
                etablissement: "l'Atome-lissasfa", // ← CORRIGÉ : utilise les guillemets doubles
                poste: "enseignant-maternelle",
                posteAutre: "",
                contrat: {
                    cdi: false,
    ...
    return (
        <>
            <header className="inscription-header-hero">
                ...
                <div className="hero-overlay"></div>
                <div className="hero-content">
                    <h1 className="inscription-titre">
                        Rejoignez notre équipe
                    </h1>
                    <p className="hero-subtitle">
                        Candidature spontanée & opportunités de carrière
                    </p>
                </div>
            </header>
                ...
                <div className="inscription-container">
                    ...
                    {isSuccess ? (
                        <div className="inscription-success">
                            ...
                            <h3>Candidature envoyée avec succès !</h3>
                            <p>
                                Nous étudierons votre profil et vous
                        ...
                        >
                                ...
                                <div className="form-field">
                                    <div className="input-wrapper">
                                        ...
                                        <select
                                            ...
                                            onChange={handleChange}
                                        >
                                            <option value="enseignant-maternelle">
                                                Enseignant(e) Maternelle
                                            </option>
                                            <option value="enseignant-primaire">
                                                Enseignant(e) Primaire
                                            </option>
                                            <option value="enseignant-college">
                                                Enseignant(e) Collège
                                            </option>
                                            <option value="enseignant-lycee">
                                                Enseignant(e) Lycée
                                            </option>
                                ...
                                <div className="form-field">
                                    ...
                                    <div className="file-upload-wrapper">
                                        ...
                                        >
                                            <Upload size={16} />
                                            {formData.diplomes
                                                ? `${formData.diplomes.length} fichier(s)`
                                                : "Parcourir..."}
                                        </label>
                                        <span className="file-name">
                                            {formData.diplomes
                                                ? `${formData.diplomes.length} fichier(s) sélectionné(s)`
                                                : "Aucun fichier sélectionné"}
                                        </span>
                                    </div>
                                </div>
                            ...
                            <div className="form-section">
                                ...
                                >
                                    ...
                                    <label className="radio-label">
                                        <input
                                            ...
                                            onChange={handleChange}
                                        />
                                        <span className="radio-custom"></span>À
                                ...
                                {formData.disponibilite === "autre" && (
                                    <div
                                        className={`form-field sub-field ${
                                            errors.disponibiliteAutre
                                                ? "error"
                                                : ""
                                        }`}
                                    >
                                        <label htmlFor="disponibiliteAutre">
                                            Si autre, précisez
                                        </label>
                                        <input
                                            type="text"
                            ...
                            <p className="form-footer">
                                ...
                                vos données soient traitées dans le cadre de
                                notre processus de recrutement. Conformément à
                                la loi, vous disposez d'un droit d'accès et de
                                rectification.
                            </p>
                        </form>
                    )}
