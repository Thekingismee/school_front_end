...
// const HomeValeurs = () => {
//   const services = [
//     { id: 1, title: 'Apprentissage et plaisir',  image: '/APPplai.jpg',  fallbackImage: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=300&q=80' },
//     { id: 2, title: 'Excellence éducative',      image: '/EDUC.jpg', fallbackImage: 'https://images.unsplash.com/photo-1524178232363-1fb2b075b655?w=300&q=80' },
//     { id: 3, title: 'Lieu convivial',            image: '/lieu.jpg', fallbackImage: 'https://images.unsplash.com/photo-1567521464027-f127ff144326?w=300&q=80' },
//     { id: 4, title: 'Ambiance studieuse',      image: '/sec.jpg', fallbackImage: 'https://images.unsplash.com/photo-1503454537195-1dcabb73ffb9?w=300&q=80' },
//     { id: 5, title: 'Croissance pédagogique',     image: '/croi.jpg', fallbackImage: 'https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?w=300&q=80' },
//     { id: 6, title: 'Bien-être émotionnel',      image: '/Mental.jpg', fallbackImage: 'https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=300&q=80' },
//   ];

//   const n = services.length;
//   // Rayon en % du conteneur (38% du côté)
//   const radiusPct = 38;
//   const cx = 50; // centre x en %
//   const cy = 50; // centre y en %
...
//                 style={{ animation: `dashflow 18s linear ${i * -3}s infinite` }}
//               />
//             );
//           })}
//         </svg>
...
//                 />
//               </div>
//               <span className="orbit-node-label">{service.title}</span>
//             </div>
//           );
//         })}
...
//           <img
//             src="/Logo Atome-AR-FR+Slogan-Final.png"
//             alt="Logo Atome"
//           />
//         </div>
//       </div>
...
//           animation: breathe 3s ease-in-out infinite;
//             object-position: center top;  /* 👈 AJOUTE cette ligne
//                                     remonte l'image pour centrer 
//                                     uniquement sur le logo sans le slogan */
//         }
//         @keyframes breathe {
//           0%, 100% { transform: scale(1); }
//           50%       { transform: scale(1.05); }
