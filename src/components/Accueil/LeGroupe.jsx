...
//                 Situé à <strong>Lissasfa à Casablanca</strong>, le{" "}
//                 <strong>Groupe Scolaire l'Atome</strong> est un établissement
//                 éducatif engagé dans la réussite et l'épanouissement des élèves.
//               </p>
//               <p className="para-line">
//                 Grâce à une approche pédagogique moderne et un encadrement de
//                 qualité, l'école accompagne les enfants dès la{" "}
//                 <strong>maternelle jusqu'au secondaire</strong> dans un
//                 environnement structuré, sécurisé et propice à l'apprentissage.
//               </p>
//             </div>
...
//             <div className="paragraph-wrapper">
//               <p className="para-line">
//                 Le <strong>Groupe Scolaire l'Atome à Lissasfa</strong> met
//                 l'accent sur un enseignement rigoureux, l'apprentissage des
//                 langues et le développement des compétences essentielles du XXIe
//                 siècle.
//               </p>
//               <p className="para-line">
//                 À travers un <strong>suivi pédagogique personnalisé</strong> et
//                 des activités éducatives variées, l'établissement prépare chaque
//                 élève à réussir son parcours scolaire tout en cultivant les
//                 valeurs de <strong>respect, responsabilité et ouverture</strong>
//                 .
//               </p>
//             </div>
...
//               <p className="line-1">
//                 Le projet éducatif du <strong>Groupe Scolaire L'Atome</strong> repose sur l'implication
//                 de femmes et d'hommes de terrain :
//               </p>

//               <p className="line-2">
//                 <strong>fondateurs, directions d'établissements, coordinateurs pédagogiques,</strong>
//               </p>

//               <p className="line-3">
//                 <strong>enseignants, éducateurs, personnels de vie scolaire et administratifs.</strong>
//               </p>

//               <p className="line-4">
//                 Tous œuvrent ensemble, avec <strong>rigueur et bienveillance</strong>, pour accompagner
//                 chaque élève dans sa singularité et son potentiel.
//               </p>
//             </div>
...
//             <img src="/equipp.jpg" alt="Équipe Groupe Scolaire L'Atome" />
//           </div>
//         </div>
//       </section>
...
//   background-position: center;
//   background-repeat: no-repeat;
//   background-attachment: fixed; /* Effet parallax pour plus de profondeur */
//   clip-path: polygon(0 0, 100% 0, 100% 100%, 0 100%);
...
//   return (
//     <div>
//       {/* Hero Section - Titre modernisé */}
//       <header className="hero-section">
//         <div className="hero-overlay"></div>
//         <div className="hero-content">
//           <h1 className="hero-title">
//             <span className="hero-title-main">Le Groupe Scolaire</span>
...
//             135deg,
//             rgba(238, 145, 31, 0.85) 0%,
//             rgba(255, 179, 0, 0.85) 50%,
//             rgba(255, 160, 83, 0.85) 100%
//           );
//           z-index: 1;
//         }
...
//           font-weight: 600;
//           color: #ffffff;
//           background: linear-gradient(135deg, #ee721f 0%, #ffa600 100%);
//           border: none;
//           border-radius: 50px;
//           cursor: pointer;
//           transition: all 0.3s ease;
...
//           background: linear-gradient(135deg, #ffa600 0%, #ee721f 100%);
//         }
