...
import React from 'react';
import { UtensilsCrossed, BusFront, Palette, Baby, ArrowRight } from 'lucide-react';
  ...
  const services = [
    {
      ...
      icon: UtensilsCrossed,
      title: "Cantine",
      description: "Réchauffage des lunchboxes préparées par les mamans dans un espace dédié. Service de commande cafeteria pour plus de variété et de praticité.",
      link: "/services/cantine"
    },
    {
      id: 2,
    ...
    },
    {
      ...
      description: "Activités artistiques et manuelles : peinture, sculpture, théâtre, musique. Développez la créativité et l'expression personnelle de votre enfant.",
