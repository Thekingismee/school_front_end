...
//           <span className="cantine-label">Restauration Scolaire</span>
//           <h2 className="cantine-title">Notre Cantine</h2>
//           <p className="cantine-paragraph">
//             Notre cantine propose des repas équilibrés et variés, préparés sur place 
//             avec des produits frais et locaux. Nous accordons une attention particulière 
//             aux régimes spéciaux et aux allergies alimentaires. Les menus sont conçus 
//             par une nutritionniste pour garantir le bien-être et la concentration 
//             optimale de vos enfants tout au long de la journée.
//           </p>
//           <a href="/cantine/menus" className="cantine-link">
//             Voir les menus du mois
//           </a>
//         </div>
