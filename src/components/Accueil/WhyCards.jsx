...
//             </svg>
//         ),
//         text: "Nous adoptons des méthodes pédagogiques innovantes qui s'adaptent au rythme et aux besoins de chaque élève, favorisant l'autonomie et la curiosité intellectuelle.",
//     },
//     {
...
//             </svg>
//         ),
//         text: "Notre équipe enseignante qualifiée assure un suivi personnalisé dans un cadre bienveillant, où chaque enfant se sent en confiance pour apprendre et progresser.",
//     },
//     {
...
//             </svg>
//         ),
//         text: "Des salles de classe équipées, des espaces de vie agréables et des outils numériques de pointe pour offrir les meilleures conditions d'apprentissage.",
//     },
//     {
...
//             </svg>
//         ),
//         text: "Un programme périscolaire varié — sport, art, culture, numérique — qui contribue au développement global de chaque élève au-delà des matières académiques.",
//     },
// ];
...
//             <p className="why-cards-subtitle">Découvrez ce qui nous rend unique</p>

//             <div className="cards-container">
//                 {cardsData.map((card, i) => {
//                     const isOpen = openIndex === i;
//                     return (
//                         <div key={i} className={`why-card ${isOpen ? "why-card--open" : ""}`}>
//                             {/* En-tête cliquable */}
//                             <button
...
//                                         <div className="card-subtitle-text">{card.subtitle}</div>
//                                     </div>
//                                 </div>
//                                 <div className={`plus-btn ${isOpen ? "plus-btn--open" : ""}`}>
//                                     <span>{isOpen ? "×" : "+"}</span>
//                                 </div>
//                             </button>
...
//                             {/* Corps avec le paragraphe bleu */}
//                             <div className={`card-body ${isOpen ? "card-body--open" : ""}`}>
...
//                 .why-card:hover {
//                     box-shadow: 0 4px 18px rgba(238, 114, 31, 0.2);
//                 }
...
//                 /* ── Texte bleu avec fond transparent ── */
//                 .card-body-text {
//                     font-size: 0.95rem;
//                     line-height: 1.7;
//                     color: #004494;
//                     background: transparent;
//                     border-left: 3px solid #ee721f;
//                     padding-left: 12px;
//                     margin: 0;
//                     margin-top: 1rem;
//                 }
