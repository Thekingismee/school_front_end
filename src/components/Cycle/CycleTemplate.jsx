...
// cycle template sans props activites primaire composant
...
// cycle template marche bien mais sans style du paragraphe
// import React from 'react';
// import Temoignages from '../Accueil/Temoignages';
// import HomeGallery from '../Accueil/HomeGallery';
...
//   // NOUVELLE PROP : composant d'activités à insérer entre le texte et HomeGallery
//   activitesComponent
// }) => {
//   return (
//     <div className="cycle-template">
...
//           {/* ACTIVITÉS - INSÉRÉES ICI APRÈS LE TEXTE */}
//           {activitesComponent && (
    ...
    return (
        <div className="cycle-template">
            ...
            <section className="cycle-content">
                <div className="cycle-content-container">
                    ...
                    <div className="cycle-content-header">
                        ...
                        {/* Conteneur bleu avec mouvement perpétuel */}
            ...
            <style jsx>{`
                ...
                /* Animation de pulsation (déplacement doux) */
                @keyframes pulse {
                    0% {
                        transform: scale(1);
                        box-shadow: 0 15px 35px rgba(30, 58, 138, 0.25);
                ...
                /* Effet de brillance qui se déplace en continu */
                .moving-shine {
                    position: absolute;
                    top: 0;
                    left: -100%;
